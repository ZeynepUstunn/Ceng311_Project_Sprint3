...
Code:  
`$("#slider").slider({ value: 50, min: 0, max: 100, slide: function(event, ui) { $("#slider-value").text(ui.value); } });`

6. **Modal (jQuery fade effect)** (Online Appointment page)  
Usage: Display confirmation message after submitting the appointment request form.  
...
3. **Page Animations** (using animate and fade effects)  
Usage:
- Animation of the welcome text (`#welcome-text`)  
  Code: `$("#welcome-text").animate({ top: "10px" }, 1000);`  
- Modal show/hide (`#success-modal`)  
